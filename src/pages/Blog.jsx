...
export default function Blog({ dark }) {
    ...
    // Share functionality - Fixed to open window synchronously
    const handleShare = (e, post, platform = 'copy') => {
        ...
        <div className="pt-24 pb-16 min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            ...
            <section className="py-16 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6 items-end">
                            {/* Search Input */}
                            <motion.div
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-3 md:py-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-colors duration-300 text-sm md:text-base"
                                    />
                                </div>
                            </motion.div>
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-4 py-3 md:py-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-colors duration-300 appearance-none cursor-pointer text-sm md:text-base"
                                    >
                                ...
                                {filteredPosts.slice(0, visible).map((post, index) => {
                                    const CardContent = (
                                        <motion.article
                                            ...
                                            layout
                                            className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-700 h-full"
                                            whileHover={{
                                                y: -8,
                                                                ...
                                                                {showShareMenu === post.id && (
                                                                    ...
                                                                    >
                                                                        <div className="p-2">
                                                                            ...
                                                                            {navigator.share && (
                                                                                <button
                                                                                    onClick={(e) => handleShare(e, post, 'native')}
                                                                            ...
                                                                            {/* X (Twitter) */}
                                                                            <button
                                                                                onClick={(e) => handleShare(e, post, 'x')}
                                                                                className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors flex items-center gap-3"
                                                                            >
                                                                            ...
                                                                            {/* LinkedIn */}
                                                                            <button
                                                                                onClick={(e) => handleShare(e, post, 'linkedin')}
                                                                                className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors flex items-center gap-3"
                                                                            >
                                                                            ...
                                                                            {/* Facebook */}
                                                                            <button
                                                                                onClick={(e) => handleShare(e, post, 'facebook')}
                                                                                className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors flex items-center gap-3"
                                                                            >
                                                                            ...
                                                                            {/* Copy Link */}
                                                                            <button
                                                                                onClick={(e) => handleShare(e, post, 'copy')}
                                                                                className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors flex items-center gap-3"
                                                                            >
